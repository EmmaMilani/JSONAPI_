...
class APIHandler(BaseHTTPRequestHandler): 
    ...
    def do_GET(self): #funziona
        if self.path == '/products': #funziona
        ...
        elif self.path.startswith('/products/'): #funziona
...
def run(server_class=HTTPServer, handler_class=APIHandler, port=8888):
    server_address = ('', port)
